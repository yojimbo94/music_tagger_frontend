function ChoiceCard({ choice, state, onClick, disabled }) {
  ...
  const base = 'relative w-full text-left rounded-xl border-2 p-4 transition-all duration-300 ease-out flex items-center gap-3'
  ...
  return (
    ...
    >
      ...
      <span className="font-medium text-gray-900 text-sm sm:text-base">{choice.label}</span>
